...
| Design agents                       | Fable | `claude-fable-5-1`            | `research-planning/system-architect.md`, `ui-designer.md`, `style-theme-expert.md` frontmatter | **All design work is Fable 5.1** (founder doctrine 2026-08-29, rolled 2026-09-01): architecture, specification consults, UX/visual design. Read-only/advisory by definition; never a builder pool                                                                                                                          |
| Fable consult + top escalation rung | Fable | `claude-fable-5-1`            | `.claude/agents/team/fable-spec-consult.md` frontmatter                                        | **Bounded, guard-gated, NEVER a lane.** Two sites only: the Step-1 §1b-bis read-only spec consult, and the Step-5 top escalation rung (ONE task, cap 2/run). Every spawn passes `plan-w-team-fable-guard.sh` (budget + cap + ledger). **Skip/refusal lands on Brain (Opus 4.8)** — never on a lower tier, never on Opus 5. |
