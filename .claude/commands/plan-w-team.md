...
- `team/builder-opus.md` mirrors `team/builder.md` (frontmatter pin + Hard-Lane Role section excepted) — when editing builder.md body sections, apply the same edit to builder-opus.md.
