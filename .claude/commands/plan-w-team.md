...
| ----------------------------------- | ----- | ----------------- | ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Lead (you)                          | Brain | Opus 5 (alias)    | invoking session default                                | Orchestration, judgment calls, scope decisions                                                                                                                                                                                                                                                          |
| Evaluator                           | Brain | `claude-opus-5`   | `.claude/agents/team/evaluator.md` frontmatter          | Independent quality assessment                                                                                                                                                                                                                                                                          |
| Fix-First Reviewer                  | Brain | `claude-opus-5`   | lead-invoked Pass 1/2 review                            | Security review, one-way door scrutiny                                                                                                                                                                                                                                                                  |
| Validator                           | Brain | `claude-opus-5`   | `.claude/agents/team/validator.md` frontmatter          | Security-critical read-only review                                                                                                                                                                                                                                                                      |
| Builder (hard lane)                 | Brain | `claude-opus-5`   | `.claude/agents/team/builder-opus.md` frontmatter       | `difficulty: hard` tasks — novel/cross-cutting/ambiguous/security                                                                                                                                                                                                                                       |
...
| Fable consult + top escalation rung | Fable | `claude-fable-5`  | `.claude/agents/team/fable-spec-consult.md` frontmatter | **Bounded, guard-gated, NEVER a lane.** Two sites only: the Step-1 §1b-bis read-only spec consult, and the Step-5 top escalation rung (ONE task, cap 2/run). Every spawn passes `plan-w-team-fable-guard.sh` (budget + cap + ledger). **Skip/refusal lands on Brain (Opus 5)** — never on a lower tier. |
...
To pin a specific generation or tier (Opus 5 vs Sonnet 5):

1. **Set the full model ID in the agent-definition frontmatter** (e.g., `model: claude-opus-5` in `.claude/agents/team/evaluator.md`).
...
When a new model generation ships (rollovers applied: Opus 4.8 on 2026-05-28; Model Tiering v2 / Sonnet-5 Hands on 2026-07-09; Model Tiering v4 / Opus-5 Brain on 2026-07-24):

- Update Brain-tier frontmatter pins to the new Opus generation (e.g., next time `claude-opus-5` → the Opus generation after it). The hard-lane `team/builder-opus` pin tracks the **Brain** generation.
