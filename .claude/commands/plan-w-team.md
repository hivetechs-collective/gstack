...
| Builder agents                      | Brain | `claude-opus-4-8` | `.claude/agents/team/builder.md` frontmatter            | Routine, well-specified implementation (default lane) — still intelligent work, so Opus 4.8 (founder doctrine 2026-08-29); Sonnet/Haiku only for the `mechanical/*` agents                                                                                                                       |
